...
This is a Fork of openai codex and the objetive is to adapt codex to use ZAI's GLM-4.7 API for benchmarking.
...
Here is a little bit of context about the ZAI API and how it works.
